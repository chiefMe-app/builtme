...
export const UAE_RENOVATION_CATALOG: RenovationCatalogItem[] = [
  ...
  { id: "cw-microcement", category: "countertop_wrap", name: "Microcement countertop finish kit", brand: "ACE UAE", supplier: "ACE UAE", price: 349, currency: "AED", unit: "estimate", tier: "premium", imageUrl: "", productUrl: ace("microcement"), renderDescription: "matte smooth warm grey-beige microcement finish on the countertop surface", styleTags: ["industrial", "minimal"], colorTags: ["grey", "concrete"] },
  ...
  { id: "cwd-matte", category: "cabinet_wrap", name: "Matte cabinet door film", brand: "Noon", supplier: "Noon", price: 89, currency: "AED", unit: "per roll", tier: "mid", imageUrl: "", productUrl: noon("matte cabinet door film"), renderDescription: "matte warm beige cabinet door and drawer front finish", styleTags: ["minimal", "modern"], colorTags: ["greige", "beige", "neutral"] },
  ...
  { id: "bs-zellige", category: "backsplash_sticker", name: "Zellige-look tile sticker", brand: "Noon", supplier: "Noon", price: 59, currency: "AED", unit: "per roll", tier: "mid", imageUrl: "", productUrl: noon("zellige tile sticker"), renderDescription: "handmade square zellige-look backsplash tiles in soft warm neutral green/cream tones, glossy glazed finish", styleTags: ["boho", "mediterranean"], colorTags: ["sage", "green", "cream"] },
  ...
  // ---------------- FLOOR STICKER ----------------
  { id: "fs-vinyl", category: "floor_sticker", name: "Peel-and-stick vinyl floor tile", brand: "Amazon AE", supplier: "Amazon.ae", price: 89, currency: "AED", unit: "per roll", tier: "budget", imageUrl: "", productUrl: amazon("peel stick vinyl floor tile"), renderDescription: "warm wood-look peel-and-stick vinyl floor plank finish on the floor surface", styleTags: ["warm minimal", "scandinavian"], colorTags: ["wood", "oak", "natural"] },
  ...
  { id: "hw-brass-pulls", category: "hardware_taps", name: "Brass drawer pulls set", brand: "Noon", supplier: "Noon", price: 129, currency: "AED", unit: "set", tier: "mid", imageUrl: "", productUrl: noon("brass drawer pulls"), renderDescription: "brushed brass / champagne gold cabinet handles and drawer pulls in the same positions", styleTags: ["glam", "warm minimal"], colorTags: ["brass", "gold"] },
